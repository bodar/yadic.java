...
public class ConstructorResolver<T> implements Resolver<T> {
    ...
    private Function<Constructor<?>, Option<Object>> firstSatisfiableConstructor(final List<Exception> exceptions, final Type type) {
        return constructor -> {
            try {
    ...
    private Function<Constructor<?>, Integer> numberOfParameters() {
